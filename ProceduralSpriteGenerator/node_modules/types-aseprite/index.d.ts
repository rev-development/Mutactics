...
declare enum SpriteSheetDataFormat {
  JSON_HASH = 0,
  JSON_ARRAY,
}
...
// ImageSpec
declare interface ImageSpecification {
  width: number;
  height: number;
  colorMode: number;
  transparentColor: number;
}
declare class ImageSpec implements ImageSpecification {
...
declare type Position = number | [number, number] | { x: number; y: number };

declare interface SpriteFile {
  fromFile: filename;
  oneFrame: Frame;
}
...
declare class ComponentProperties implements ComponentOptions {
