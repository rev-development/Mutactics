...
public partial class @DefaultControls: IInputActionCollection2, IDisposable
{
    ...
    ~@DefaultControls()
    {
        ...
        UnityEngine.Debug.Assert(!m_CampaignMap.enabled, "This will cause a leak and performance issues, DefaultControls.CampaignMap.Disable() has not been called.");
    }
    ...
    /// </summary>
    public struct CampaignMapActions
    {
        private @DefaultControls m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public CampaignMapActions(@DefaultControls wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        ...
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_CampaignMap; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="CampaignMapActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(CampaignMapActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="CampaignMapActions" />
        public void AddCallbacks(ICampaignMapActions instance)
        {
            if (instance == null || m_Wrapper.m_CampaignMapActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_CampaignMapActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="CampaignMapActions" />
        private void UnregisterCallbacks(ICampaignMapActions instance)
        {
            @Pan.started -= instance.OnPan;
            @Pan.performed -= instance.OnPan;
            @Pan.canceled -= instance.OnPan;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="CampaignMapActions.UnregisterCallbacks(ICampaignMapActions)" />.
        /// </summary>
        /// <seealso cref="CampaignMapActions.UnregisterCallbacks(ICampaignMapActions)" />
        public void RemoveCallbacks(ICampaignMapActions instance)
        {
            if (m_Wrapper.m_CampaignMapActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="CampaignMapActions.AddCallbacks(ICampaignMapActions)" />
        /// <seealso cref="CampaignMapActions.RemoveCallbacks(ICampaignMapActions)" />
        /// <seealso cref="CampaignMapActions.UnregisterCallbacks(ICampaignMapActions)" />
        public void SetCallbacks(ICampaignMapActions instance)
        {
            foreach (var item in m_Wrapper.m_CampaignMapActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_CampaignMapActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="CampaignMapActions" /> instance referencing this action map.
    /// </summary>
    public CampaignMapActions @CampaignMap => new CampaignMapActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "CampaignMap" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="CampaignMapActions.AddCallbacks(ICampaignMapActions)" />
    /// <seealso cref="CampaignMapActions.RemoveCallbacks(ICampaignMapActions)" />
    public interface ICampaignMapActions
    {
        /// <summary>
