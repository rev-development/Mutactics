    ...
    internal class DictionaryLookupTable<TKey, TValue> : IKeyable
    {
        ...
        public void RecalculateOccurences() {
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                if (!SerializedCollectionsUtility.IsValidKey(kvp.Key)) continue;
        ...
        public void RemoveKey(object key) {
            for (var i = _dictionary._serializedList.Count - 1; i >= 0; i--)
            {
                ...
                if (SerializedCollectionsUtility.KeysAreEqual(dictKey, key)) _dictionary._serializedList.RemoveAt(i);
            }
        }
        ...
        public void RemoveDuplicates() {
            _dictionary._serializedList = _dictionary._serializedList.GroupBy
                                                          (x => x.Key)
