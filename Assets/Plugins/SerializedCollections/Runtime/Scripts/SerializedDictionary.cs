...
namespace AYellowpaper.SerializedCollections
{
    ...
    public class SerializedDictionary<TKey, TValue> : Dictionary<TKey, TValue>, ISerializationCallbackReceiver
    {
        ...
        private void SyncDictionaryToBackingField_Editor() {
            foreach (var kvp in this) _serializedList.Add(new SerializedKeyValuePair<TKey, TValue>(kvp.Key, kvp.Value));
        }
        ...
        internal IKeyable LookupTable
        {
            get
            {
                if (_lookupTable == null) _lookupTable = new DictionaryLookupTable<TKey, TValue>(this);
        ...
        public new TValue this[TKey key]
        {
            ...
            set
            {
                ...
                for (var i = 0; i < _serializedList.Count; i++)
                {
                    ...
                    if (!SerializedCollectionsUtility.KeysAreEqual(key, kvp.Key)) continue;
                ...
                if (!anyEntryWasFound) _serializedList.Add(new SerializedKeyValuePair<TKey, TValue>(key, value));
            }
        }
