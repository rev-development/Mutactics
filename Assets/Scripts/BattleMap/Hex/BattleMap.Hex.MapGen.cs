...
namespace BattleMap.Hex
{
	public static class MapGen
	{
		...
		public static void ApplyAltitude(
			...
			var adjacentCellCords = Rev.Helpers.HexMap.GetAdjacentCells(hexData.Cell)
		...
		public static SerializedDictionary<Vector2Int, HexData> GetEdgeHexes(
			...
			var edgeHexKeys = Rev.Helpers.HexMap.GetEdgeCells(
					mapData.Values.Select(cell => cell.Key).ToList(),
					mapSize
				);
