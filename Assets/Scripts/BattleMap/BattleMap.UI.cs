...
namespace BattleMap
{
	...
	public class UI : MonoBehaviour
	{
		...
		public InfoGroup HexInfoGroup;

		public InfoGroup PawnInfoGroup;
		...
		public void OnEnable() {
			...
			HexInfoGroup = new InfoGroup(root.Q<GroupBox>("Hex_InfoGroup"), root.Q<Label>("Hex_CellLabel"));

			PawnInfoGroup = new InfoGroup(root.Q<GroupBox>("Pawn_InfoGroup"), root.Q<Label>("Pawn_CellLabel"));
